...
class DTGAL_dash_page {
	...
	public function __construct( $name, $name_s ){
		DTGAL_dash_page::$instances[] = $this; 
		$this->name = $name;
		$this->name_s = $name; 
		$this->menu_pos = 82.1 + ( count( DTGAL_dash_page::$instances )/10 );
	...
	public function page_function(){
		...
		$out .= "<div class='wrap'>";
			...
			foreach( DTGAL_post_type::$instances as $pt  ){
				...
				$out .= "<div style='padding: 25px' class='postbox'>";
					...
					//Shortcodes Info Output
						...
						$out .= "<hr>";
						foreach ( DTGAL_pt_sc::$instances as $sc ){
					...
					//Technical Info Output
						...
						$out .= "<ul>";
							...
							$out .= "<li>Plugin Slug: " . "DTGAL</li>";
						$out .= "</ul>";

						$out .= "<h3>Meta</h3>";
						$out .= "<ul>";
							foreach( DTGAL_pt_meta::$instances as $meta ){
						...
						$out .= "<ul>";
							foreach( DTGAL_pt_tax::$instances as $tax ){
